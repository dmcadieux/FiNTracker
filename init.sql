...
INSERT INTO transactions (user_id, account_id, category, transaction_name, amount)
VALUES
	(1, 1, 'fun', 'pot brownies', 10.20),
	(2, 1, 'fun', 'grey goose', 99.99),
	(1, 2, 'groceries', 'loblaws order', 20.20),
	(1, 3, 'subscriptions', 'netflix', 11.99)
;
